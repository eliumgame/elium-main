...
const STOP_WORDS = new Set([
  ...
  "à", "en", "dans", "par", "pour", "sur", "sous", "avec", "sans", "que", "qui",
  "quoi", "dont", "ce", "cet", "cette", "ces", "se", "sa", "son", "ses", "il",
  "elle", "ils", "elles", "on", "nous", "vous", "je", "tu", "me", "te", "lui",
  "leur", "leurs", "est", "sont", "été", "être", "a", "ont", "avoir", "plus",
  "moins", "ne", "pas", "ni", "mais", "donc", "or", "car", "si", "y", "tout",
  "tous", "toute", "toutes", "comme", "aussi", "bien", "très", "peu", "fait",
  "faire", "cela", "ça", "ainsi", "alors", "entre", "vers", "chez", "the", "of",
  "and", "to", "in", "is", "it", "for", "as", "was", "on", "are", "with", "be",
  "this", "that", "these", "those", "which", "who", "whom", "from", "by", "at",
  "or", "an", "we", "you", "they", "he", "she", "his", "her", "its", "our",
  "your", "their", "not", "but", "have", "has", "had", "will", "would", "can",
  "could", "should", "into", "out", "up", "down", "over", "under", "again",
  "then", "once", "here", "there", "when", "where", "why", "how", "all", "so",
