    ...
    <div className="dc-link-open">
      <div className="dc-link-card">
        <div className="dc-auth__brand-row">
          <Cloud size={26} /> <span>Elium Drive</span>
        </div>
        {state.phase === "loading" && (
          <p className="muted">
            <Loader size={16} className="dc-spin" /> Ouverture du lien chiffré…
          </p>
        )}
        {state.phase === "password" && (
          <>
            ...
            <h1>Lien protégé</h1>
            <p className="muted">
              Ce lien est protégé par un mot de passe. Saisissez-le pour déchiffrer le fichier (le mot de passe ne
              quitte jamais votre navigateur).
            </p>
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              ...
              <button className="eb eb--primary eb--block" disabled={unlocking || !pwd}>
        ...
        {state.phase === "ready" && (
          <>
            ...
            <h1>{state.name}</h1>
            <p className="muted">
              Fichier partagé, chiffré de bout en bout. Le secret de déchiffrement n'a jamais quitté votre navigateur.
            </p>
