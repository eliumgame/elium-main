...
/**
 * Les deux familles de notes vivent dans `noteExtensions.ts`, construites par une
 * fabrique commune : leur numérotation doit rester unique (cf. `notes.ts`), donc
 * ces nœuds sont seulement réexportés ici pour ne casser aucun import existant.
 */
export { Footnote, FootnotesList } from "./noteExtensions";
