...
export const READING_THEMES: { id: ReadingTheme; label: string; filter: string; canvas: string }[] = [
  ...
  { id: "night", label: "Nuit", filter: "invert(0.9) hue-rotate(180deg) brightness(1.05) contrast(0.92)", canvas: "#12161d" },
...
export const TOOL_TAB: Partial<Record<Tool, RibbonTab>> = {
  highlight: "comment", underline: "comment", strikeout: "comment", squiggly: "comment",
  note: "comment", freetext: "comment", callout: "comment", ink: "comment", square: "comment",
  circle: "comment", line: "comment", arrow: "comment", polygon: "comment", polyline: "comment",
  cloud: "comment", stamp: "comment", eraser: "comment",
  typewriter: "edit", image: "edit", link: "edit", whiteout: "edit",
  redact: "protect",
  distance: "view", perimeter: "view", area: "view",
  signature: "home",
};
