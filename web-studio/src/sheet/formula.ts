...
export const FUNCTIONS: FnDoc[] = [
  ...
  {
    name: "XLOOKUP",
    sig: "XLOOKUP(clé; plage_rech; plage_ret; [si_absent])",
    desc: "Recherche moderne (correspondance exacte)",
    cat: "Recherche",
  },
  ...
  {
    name: "TEXTJOIN",
    sig: "TEXTJOIN(sép; ignorer_vides; texte1; …)",
    desc: "Joint du texte avec séparateur",
    cat: "Texte",
  },
