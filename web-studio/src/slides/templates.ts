...
export const SLIDE_TEMPLATES: SlideTemplate[] = [
  {
    ...
    build: () => [
      t({
        ...
        w: 84,
        h: 18,
        html: "<p>Titre de la présentation</p>",
        fontSize: 54,
        align: "center",
        valign: "middle",
      }),
  ...
  },
  {
    ...
    build: () => [
      ...
      t({
        ...
        w: 86,
        h: 66,
        html: "<ul><li>Premier point</li><li>Deuxième point</li></ul>",
        fontSize: 24,
        valign: "top",
      }),
    ],
  ...
  },
  {
    ...
    build: () => [
      t({
        ...
        w: 76,
        h: 28,
        html: "<p>« Une citation inspirante. »</p>",
        fontSize: 40,
        color: "#f8fafc",
        align: "center",
        valign: "middle",
  ...
  },
  {
    ...
    build: () => [
      ...
      t({
        ...
        w: 86,
        h: 66,
        html: "<ol><li>Introduction</li><li>Contexte</li><li>Proposition</li><li>Prochaines étapes</li></ol>",
        fontSize: 26,
        valign: "top",
      }),
    ],
  },
  {
    ...
    build: () => [
      ...
      t({
        ...
        w: 36,
        h: 44,
        html: "<ul><li>Avantage</li><li>Avantage</li></ul>",
        fontSize: 20,
        valign: "top",
      }),
      t({
  ...
  },
  {
    ...
    build: () => [
      ...
      t({
        ...
        w: 76,
        h: 12,
        html: "<p>de satisfaction client</p>",
        fontSize: 26,
        color: "#99f6e4",
        align: "center",
        valign: "top",
  ...
  },
  {
    ...
    build: () => [
      ...
      t({
        ...
        w: 30,
        h: 56,
        html: "<ul><li>Point clé</li><li>Point clé</li><li>Point clé</li></ul>",
        fontSize: 22,
        valign: "top",
      }),
    ],
